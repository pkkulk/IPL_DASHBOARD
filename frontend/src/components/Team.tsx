...
const Team = () => {
  ...
  <div className="flex flex-col items-center  shadow-2xl p-4 rounded-lg bg-white">
    <Link href="/teams" className="font-semibold hover:text-blue-500 text-center">
      <Image src="/MI.png" alt="Mumbai Indians" width={100} height={100} className="mb-2 h-36 w-40"/>
      Mumbai <br/> Indians
    </Link>
  </div>
  ...
  <div className="flex flex-col items-center bg-gray-100 shadow-2xl p-4 rounded-lg  bg-white">
    <Link href="/teams" className="font-semibold hover:text-blue-500 text-center">
      <Image src="/csk.png" alt="Chennai Super Kings" width={100} height={100} className="mb-2 h-36 w-36"/>
  ...
  <div className="flex flex-col items-center bg-gray-100 shadow-2xl p-4 rounded-lg  bg-white">
    <Link href="/teams" className="font-semibold hover:text-blue-500 text-center">
      <Image src="/RCB.jpeg" alt="Royal Challengers Bangalore" width={120} height={100} className="mb-2 h-36 w-36"/>
  ...
  <div className="flex flex-col items-center bg-gray-100 shadow-2xl p-4 rounded-lg  bg-white">
    <Link href="/teams" className="font-semibold hover:text-blue-500 text-center">
      <Image src="/SRH.jpeg" alt="Kolkata Knight Riders" width={100} height={100} className="mb-2 h-36 w-36"/>
